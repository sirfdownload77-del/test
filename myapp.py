...
def render_summons(court, case_no, plaintiff, versus, defendant_address, subject, hearing, issuance, note):
    ...
    <div class="summons-box" style="direction: rtl; line-height: 1.7;">
        ...
        <div style="font-size: 11px; border-top: 1px solid #000; padding-top: 10px; margin-top: auto; padding-bottom: 20px;">
            <b>اطلاع:</b>  اگر آپ کو یہ اندیشہ ہو کہ آپ کے گواہ اپنی مرضی سے حاضر نہ  ہوں گے تو آپ عدالت سے سمن بایں مراد جاری کرا سکتے ہیں کہ جو گواہ حاضر نہ ہو وہ جبراً حاضر کرایا جائے اور جس دستاویز سے پیش کرانے کااستحقاق رکھتے ہوں اسے پیش کرائی جائے بشرطیکہ آپ خرچہ ضروری عدالت میں داخل کرکے اس امر کی درخواست گذاریں(2) اگر مطالبہ مدعی تسلیم کرتےہوں تو آپ کو لازم ہے کہ روپیہ اور خرچہ ثالثی عدالت میں داخل کریں تاکہ کارروائی باجراء ڈگری کی جو آپ کی ذات یا مالی درخواست دونوں پر کوئی اثر نہ پڑے۔
            <br><br>
            <b>نوٹ:</b>    اگر تحریری بیان کی ضرورت ہو تویہ لکھیں آپ کو یا فلاں فریق کو جیسی صورتحال ہو تو چاہیے کہ بتاریخ <b>{n_str}</b> تک تحریر بیان داخل کریں     </div>
    </div>
    """
